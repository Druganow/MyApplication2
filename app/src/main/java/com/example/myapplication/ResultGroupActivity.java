...
public class ResultGroupActivity   extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.result_group);
        update();
    }
    ...
    private void update() {
        ...
        TextView displayTextView = (TextView) findViewById(R.id.textView8);
        while (cursor.moveToNext())
        {
            ...
            Cursor cursor1 =  db1.rawQuery("SELECT * FROM " + SportsmenContract.GuestEntry.TABLE_NAME +
                    " WHERE yahr >= " + Yahr1 + " and yahr <= "+ Yahr2 + " and gender == " +Gender+ " ORDER by result", null);
            ...
            int timeColumnIndex = cursor1.getColumnIndex(SportsmenContract.GuestEntry.TIME_RESULT);
int i =0;
